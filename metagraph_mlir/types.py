...
if has_mlir_graphblas:
    ...
    # class MLIRGraphBLASEdgeSet(EdgeSetWrapper, abstract=EdgeSet):
    ...
    #             assert (
    #                 m1.ndim == m2.ndim
    #             ), f"size mismatch: {m1.ndim} != {m2.ndim}"
    ...
    #             assert m1_indices == m2_indices, f"edge mismatch {m1_indices} != {m2_indices}"

    # class MLIRGraphBLASEdgeMap(EdgeMapWrapper, abstract=EdgeMap):
